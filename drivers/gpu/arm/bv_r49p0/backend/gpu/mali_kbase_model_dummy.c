...
#if !MALI_USE_CSF
static void bv_r49p0_model_dump_prfcnt(void)
{
	unsigned long flags;
...
void *bv_r49p0_model_create(struct kbase_device *kbdev)
{
...
void bv_r49p0_model_destroy(void *h)
{
	kfree((void *)h);
}

static void bv_r49p0_model_get_outputs(void *h)
{
...
static void bv_r49p0_model_update(void *h)
{
	struct dummy_model_t *dummy = (struct dummy_model_t *)h;
	u32 i;
...
void bv_r49p0_model_write_reg(void *h, u32 addr, u32 value)
{
	unsigned long flags;
	struct dummy_model_t *dummy = (struct dummy_model_t *)h;
	...
	bv_r49p0_model_update(dummy);
	bv_r49p0_model_get_outputs(dummy);
	spin_unlock_irqrestore(&hw_error_status.access_lock, flags);
}

void bv_r49p0_model_read_reg(void *h, u32 addr, u32 *const value)
{
	unsigned long flags;
	struct dummy_model_t *dummy = (struct dummy_model_t *)h;
